...
class BankTransactionTest < Test::Unit::TestCase
  ...
  should_protect_attributes :family_id, :bank_account_id
  should_allow_attributes :family, :bank_account, :amount, :posted_on, :name, :memo, :fitid, :bank_transactions, :pending
