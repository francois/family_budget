...
class BankTransactionTest < Test::Unit::TestCase
  ...
  should_belong_to :family, :bank_account, :credit_account, :debit_account, :transfer
  should_protect_attributes :family_id, :bank_account_id, :credit_account_id, :debit_account_id
  should_allow_attributes :family, :bank_account, :credit_account, :debit_account, :amount, :posted_on, :name, :memo, :fitid, :bank_transactions
